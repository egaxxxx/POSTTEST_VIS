...
Public Class frmProdukJadi
    ...
    Private Sub btnSimpan_Click(sender As Object, e As EventArgs) Handles btnSimpan.Click
        ...
        If selectedId = -1 Then
            If InsertProduk(txtNama.Text.Trim(), cboKategori.Text, hargaTemp, stokTemp, txtKet.Text.Trim()) Then
                MessageBox.Show("Produk berhasil ditambahkan!", "Sukses", MessageBoxButtons.OK, MessageBoxIcon.Information)
                LoadData()
                ResetForm()
            End If
        Else
            If UpdateProduk(selectedId, txtNama.Text.Trim(), cboKategori.Text, hargaTemp, stokTemp, txtKet.Text.Trim()) Then
